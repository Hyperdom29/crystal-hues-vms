...
if (count === 0) {
  ...
  seedMany([
    ...
    },
    {
      ...
      phone: "+91 87654 32109", location: "Delhi, India",
      type: "Transcriptionist",
    ...
    },
    {
      ...
      phone: "+55 11 98765-4321", location: "São Paulo, Brazil",
      type: "Voice Artist",
    ...
    },
    {
      ...
      phone: "+81 90-1234-5678", location: "Tokyo, Japan",
      type: "Translator",
    ...
    },
    {
      ...
      phone: "+1 415 555-0199", location: "San Francisco, USA",
      type: "Agency",
    ...
    },
    {
      ...
      phone: "+33 6 12 34 56 78", location: "Paris, France",
      type: "Interpreter",
    ...
    },
    {
      ...
      phone: "+86 138 0013 8000", location: "Shanghai, China",
      type: "Data Annotator",
